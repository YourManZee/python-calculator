...
def apply_theme(theme):
    ...
    # Backspace button
    backspace_button.config(bg=theme["special_bg"], fg="white")
...
# Backspace button
backspace_button = create_button("⌫", 1, 3,
...
# Button 0
number_buttons.append(
    create_button("0", 5, 0, colspan=2, cmd=lambda: button_click("0"))
)

# Decimal button
number_buttons.append(
    create_button(".", 5, 2, cmd=lambda: button_click("."))
)
...
# Clear button
clear_button = create_button("C", 6, 0, colspan=2,
                             bg=current_theme["special_bg"],
                             cmd=clear_display)

# Equals button
equals_button = create_button("=", 6, 2, colspan=2,
